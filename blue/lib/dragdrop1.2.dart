...
class QuantumDesignHome extends StatefulWidget {
  const QuantumDesignHome({super.key});

  @override
  _QuantumDesignHomeState createState() => _QuantumDesignHomeState();
}

class _QuantumDesignHomeState extends State<QuantumDesignHome> {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          SenderScreen(initialState: currentState)),
                );
              },
...
// Keep the existing DraggableGateItem, GateItem, and CircuitPainter classes from the previous implementation
